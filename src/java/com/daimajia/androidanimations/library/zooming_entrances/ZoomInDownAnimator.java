...
public class ZoomInDownAnimator
extends BaseViewAnimator {
    ...
    public void prepare(View view) {
        ...
        float[] arrf = new float[]{-view.getBottom(), 60.0f, 0.0f};
        arranimator[2] = ObjectAnimator.ofFloat((Object)view, (String)"translationY", (float[])arrf);

            ...
            do {
                block14 : {
                    block16 : {
                        block15 : {
                            block13 : {
                                var10_3 = FocusFinder.getInstance().findNextFocus((ViewGroup)this, var2_2, var1_1);
                            ...
                            if (var1_1 != 17 && var1_1 != 1) break block15;
                            var11_6 = this.pageLeft();
                            break block14;
                        }
                        if (var1_1 == 66) break block16;
                        var11_6 = false;
        ...
        block17 : {
            ...
            switch (var2_2) {
                case 2: {
                    ...
                    if (var6_3 != -1) {
                        var7_4 = MotionEventCompat.findPointerIndex((MotionEvent)var1_1, (int)var6_3);
                        var8_5 = MotionEventCompat.getX((MotionEvent)var1_1, (int)var7_4);
                        var9_6 = var8_5 - this.mLastMotionX;
                        var10_7 = Math.abs((float)var9_6);
                        var11_8 = MotionEventCompat.getY((MotionEvent)var1_1, (int)var7_4);
                        var12_9 = Math.abs((float)(var11_8 - this.mInitialMotionY));
                        if (var9_6 != 0.0f && !this.isGutterDrag(this.mLastMotionX, var9_6) && this.canScroll((View)this, false, (int)var9_6, (int)var8_5, (int)var11_8)) {
                        ...
                        if (var10_7 > (float)this.mTouchSlop && 0.5f * var10_7 > var12_9) {
                            ...
                            this.setScrollState(1);
                            var13_10 = var9_6 > 0.0f ? this.mInitialMotionX + (float)this.mTouchSlop : this.mInitialMotionX - (float)this.mTouchSlop;
                            this.mLastMotionX = var13_10;
                            this.mLastMotionY = var11_8;
                            this.setScrollingCacheEnabled(true);
                        } else if (var12_9 > (float)this.mTouchSlop) {
                            this.mIsUnableToDrag = true;
                        }
                        if (this.mIsBeingDragged && this.performDrag(var8_5)) {
                            ViewCompat.postInvalidateOnAnimation((View)this);
                            ** break;
                        }
                    }
                ...
                case 0: {
                    this.mInitialMotionX = var3_11 = var1_1.getX();
                    this.mLastMotionX = var3_11;
                    this.mInitialMotionY = var4_12 = var1_1.getY();
                    this.mLastMotionY = var4_12;
                    this.mActivePointerId = MotionEventCompat.getPointerId((MotionEvent)var1_1, (int)0);
                    this.mIsUnableToDrag = false;
    ...
    protected void onPageScrolled(int n, float f, int n2) {
        if (this.mDecorChildCount > 0) {
            ...
            for (int i = 0; i < n7; ++i) {
                ...
                if ((n9 = n8 + n3 - view.getLeft()) == 0) continue;
        ...
        if (this.mPageTransformer != null) {
            ...
            for (int i = 0; i < n11; ++i) {
                ...
                float f2 = (float)(view.getLeft() - n10) / (float)this.getClientWidth();
        ...
        block18 : {
            ...
            switch (var2_2) {
                case 0: {
                    ...
                    this.mPopulatePending = false;
                    this.populate();
                    this.mInitialMotionX = var20_4 = var1_1.getX();
                    this.mLastMotionX = var20_4;
                    this.mInitialMotionY = var21_5 = var1_1.getY();
                    this.mLastMotionY = var21_5;
                    this.mActivePointerId = MotionEventCompat.getPointerId((MotionEvent)var1_1, (int)0);
                    var3_3 = false;
                    ** break;
                }
                case 2: {
                    if (!this.mIsBeingDragged) {
                        var13_6 = MotionEventCompat.findPointerIndex((MotionEvent)var1_1, (int)this.mActivePointerId);
                        var14_7 = MotionEventCompat.getX((MotionEvent)var1_1, (int)var13_6);
                        var15_8 = Math.abs((float)(var14_7 - this.mLastMotionX));
                        var16_9 = MotionEventCompat.getY((MotionEvent)var1_1, (int)var13_6);
                        var17_10 = Math.abs((float)(var16_9 - this.mLastMotionY));
                        if (var15_8 > (float)this.mTouchSlop && var15_8 > var17_10) {
                            this.mIsBeingDragged = true;
                            this.requestParentDisallowInterceptTouchEvent(true);
                            var18_11 = var14_7 - this.mInitialMotionX > 0.0f ? this.mInitialMotionX + (float)this.mTouchSlop : this.mInitialMotionX - (float)this.mTouchSlop;
                            this.mLastMotionX = var18_11;
                            this.mLastMotionY = var16_9;
                            this.setScrollState(1);
                            this.setScrollingCacheEnabled(true);
                            var19_12 = this.getParent();
                            if (var19_12 != null) {
                                var19_12.requestDisallowInterceptTouchEvent(true);
                            }
                        }
                    }
                    var12_13 = this.mIsBeingDragged;
                    var3_3 = false;
                    if (var12_13) {
                        var3_3 = false | this.performDrag(MotionEventCompat.getX((MotionEvent)var1_1, (int)MotionEventCompat.findPointerIndex((MotionEvent)var1_1, (int)this.mActivePointerId)));
                        ** break;
                    }
                    ** GOTO lbl81
                }
                case 1: {
                    var6_14 = this.mIsBeingDragged;
                    var3_3 = false;
                    if (var6_14) {
                        var7_15 = this.mVelocityTracker;
                        var7_15.computeCurrentVelocity(1000, (float)this.mMaximumVelocity);
                        var8_16 = (int)VelocityTrackerCompat.getXVelocity((VelocityTracker)var7_15, (int)this.mActivePointerId);
                        this.mPopulatePending = true;
                        var9_17 = this.getClientWidth();
                        var10_18 = this.getScrollX();
                        var11_19 = this.infoForCurrentScrollPosition();
                        this.setCurrentItemInternal(this.determineTargetPage(var11_19.position, ((float)var10_18 / (float)var9_17 - var11_19.offset) / var11_19.widthFactor, var8_16, (int)(MotionEventCompat.getX((MotionEvent)var1_1, (int)MotionEventCompat.findPointerIndex((MotionEvent)var1_1, (int)this.mActivePointerId)) - this.mInitialMotionX)), true, true, var8_16);
                        this.mActivePointerId = -1;
                        this.endDrag();
                ...
                case 5: {
                    var4_21 = MotionEventCompat.getActionIndex((MotionEvent)var1_1);
                    this.mLastMotionX = MotionEventCompat.getX((MotionEvent)var1_1, (int)var4_21);
                    this.mActivePointerId = MotionEventCompat.getPointerId((MotionEvent)var1_1, (int)var4_21);
                    var3_3 = false;
                }
lbl81: // 9 sources:
                default: {
            ...
            this.onSecondaryPointerUp(var1_1);
            this.mLastMotionX = MotionEventCompat.getX((MotionEvent)var1_1, (int)MotionEventCompat.findPointerIndex((MotionEvent)var1_1, (int)this.mActivePointerId));
            var3_3 = false;
        }
    ...
    void populate(int n) {
        ...
        block26 : {
            ...
            this.calculatePageOffsets(itemInfo, n4, itemInfo2);
        }
        PagerAdapter pagerAdapter = this.mAdapter;
    ...
    extends AccessibilityDelegateCompat {
        ...
        public boolean performAccessibilityAction(View view, int n, Bundle bundle) {
            ...
            switch (n) {
                ...
                case 4096: {
                    if (ViewPagerEx.this.canScrollHorizontally(1)) {
                        ViewPagerEx.this.setCurrentItem(1 + ViewPagerEx.this.mCurItem);
                        return true;
                    }
                    return false;
                }

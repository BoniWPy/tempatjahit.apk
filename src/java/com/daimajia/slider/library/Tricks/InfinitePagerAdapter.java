...
extends PagerAdapter {
    ...
    public void destroyItem(ViewGroup viewGroup, int n, Object object) {
        ...
        this.debug("destroyItem: real position: " + n);
        this.debug("destroyItem: virtual position: " + n2);
    ...
    public Object instantiateItem(ViewGroup viewGroup, int n) {
        ...
        int n2 = n % this.getRealCount();
        this.debug("instantiateItem: real position: " + n);
        this.debug("instantiateItem: virtual position: " + n2);
